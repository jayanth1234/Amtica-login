    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [
                ...
                angular_flash_message__WEBPACK_IMPORTED_MODULE_5__["FlashMessageModule"]
            ],
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_0__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_13__["AuthService"]],
...
module.exports = "<h1 class=\"container jumbotron text-center\">\n    <div *ngIf=\"user\">\n        <h2>Hi {{user.name}}</h2>\n    </div>\n  <button type=\"button\" class=\"btn btn-primary\" (click) = \"onLogoutClick()\" >\n    Logout\n  </button>\n</h1>\n\n\n"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(router, authService, flashMessage) {
        this.router = router;
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.success('Logged In successfully', { delay: 3000, close: true });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flashMessage.danger(data.msg, { delay: 3000, close: true });
...
/* harmony import */ var angular_flash_message__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! angular-flash-message */ "./node_modules/angular-flash-message/dist/index.js");
/* harmony import */ var angular_flash_message__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(angular_flash_message__WEBPACK_IMPORTED_MODULE_0__);
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(flashMessage, validateService, authService, router) {
        this.flashMessage = flashMessage;
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            console.log(data);
            if (data.success) {
                _this.flashMessage.success('User successfully Registered!! Now you can Login', { delay: 3000, close: true });
                _this.router.navigate(['/']);
            }
            else {
                _this.flashMessage.danger('Something went wrong', { delay: 3000, close: true });
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [angular_flash_message__WEBPACK_IMPORTED_MODULE_0__["FlashMessage"],
...
module.exports = __webpack_require__(/*! C:\Users\Jayanth\Login\MeanLogin App\angular-login\src\main.ts */"./src/main.ts");
